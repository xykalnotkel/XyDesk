...
## Validation
Linux176, web84, backend188, NSIS builder7 PASS. Browser controls (two viewports) and remembered-access/revoke fixture PASS. Real Worker/SQLite/WebSocket runtime authorization PASS. Windows first run35420994164 caught two missing mouse-flag imports; fixed before delivery. Final Windows35421194650 SUCCESS (Windows165 plus native job lifetime in PS5/PS7), NSIS35421544833 SUCCESS. Backend/web deployed separately after tests; package/production proof adjacent. No claim of Windows field cursor/reconnect success before the new binary is installed by user.
