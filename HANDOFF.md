...
- [ ] (Operator - XyDesk Team, 2026-09-18) — CONTROL-REFINE source web siap:70tes/build/Chromium gesture/mapping/reconnect PASS. Perlu izin deploy web-only terpisah; gunakan OAuth client produksi lama saat build. Tidak perlu build NSIS/backend baru. User memilih desktop host16:9; platform RDP/resolusi yang didukung belum dikonfirmasi, belum mengubah RDP. Minta stats jaringan/buffer/decode/FPS + log encode untuk diagnosis delay, bukan klaim sebab jaringan. Bukti `docs/qa/control-refine-2026-09-18.md`.
