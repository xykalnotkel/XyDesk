# Arsip Changelog XyDesk — 2.4.0 s/d 6.4.0

Versi awal XyDesk (Juli–Agustus 2026), digabung jadi satu berkas biar
index changelog tetap ringkas. Sejarah lengkap tetap tersimpan di git.
