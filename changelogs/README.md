# Changelogs XyDesk — per versi

Setiap versi punya file sendiri biar ga numpuk (kebijakan Founder 2026-09-07). File utama `CHANGELOG.md` tetap ada sebagai ringkasan index, tapi detail per versi ada di sini.
