...
|---|---|---|---|---|---|
| SESI-20260903-DANU-WEB7 | Danu - XySpace Team | Web | LAGI KERJA | Sewa PC: durasi custom + stok per paket; layar sesi: total & sisa waktu (chip + panel); HANDOFF parity APK | 2026-09-03 |
...
| SESI-20260903-DANU-WEB7 | Danu - XySpace Team | Web: /billing durasi custom (input jam + chip cepat) + ketersediaan stok per paket (config + status habis), layar sesi web chip total & sisa waktu sesi tamu (2 jam) + baris Total/Sisa di tab Sesi; HANDOFF parity APK (Client Flutter); CHANGELOG | DISETUJUI | Xyckal (chat) | 2026-09-03 | — |
