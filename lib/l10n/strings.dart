...
const Map<String, Map<String, String>> kStrings = {
  ...
  'news_subtitle': {
    ...
    'pt': 'Atualizações, decisões técnicas e números que medimos nós mesmos.',
    'ar': 'تحديثات المنتج وقرارات الهندسة والأرقام التي نقيسها بأنفسنا.',
  },
  'news_empty': {
    'id': 'Belum ada berita di kategori ini.',
    'en': 'No news in this category yet.',
    'zh': '此分类暂无新闻。',
    'es': 'Aún no hay noticias en esta categoría.',
    'pt': 'Ainda não há notícias nesta categoria.',
    'ar': 'لا توجد أخبار في هذا التصنيف بعد.',
  },
  'news_load_error': {
    'id': 'Tidak dapat memuat berita. Coba lagi.',
    'en': 'Could not load news. Try again.',
    'zh': '无法加载新闻。请重试。',
    'es': 'No se pudieron cargar las noticias. Inténtalo de nuevo.',
    'pt': 'Não foi possível carregar as notícias. Tente novamente.',
    'ar': 'تعذر تحميل الأخبار. حاول مجددًا.',
  },
  'news_retry': {
    'id': 'Coba lagi',
    'en': 'Retry',
  ...
  // ── Berita: balasan & langganan email (rilis 6.0) ─────
  'news_reply': {
    'id': 'Balas',
    'en': 'Reply',
    'zh': '回复',
  ...
  'news_subscribe_title': {
    'id': 'Berita lewat email',
    'en': 'News by email',
    'zh': '通过电子邮件获取新闻',
    'es': 'Noticias por correo',
    'pt': 'Notícias por e-mail',
    'ar': 'الأخبار عبر البريد الإلكتروني',
  },
  'news_subscribe_sub': {
    'id': 'Artikel baru dikirim langsung ke email kamu.',
    'en': 'New articles delivered straight to your email.',
    'zh': '新文章直接发送到您的邮箱。',
    'es': 'Artículos nuevos directo a tu correo.',
    'pt': 'Artigos novos direto no seu e-mail.',
    'ar': 'تصلك المقالات الجديدة مباشرة إلى بريدك.',
  },
  'news_subscribe_email_hint': {
    'id': 'alamat@email.com',
    'en': 'address@email.com',
    'zh': '邮箱地址',
    'es': 'correo@email.com',
    'pt': 'email@email.com',
    'ar': 'بريد@example.com',
  ...
  'news_subscribe_ok': {
    'id': 'Berhasil! Email kamu terdaftar untuk berita XyDesk.',
    'en': 'Done! Your email is subscribed to XyDesk news.',
    'zh': '成功！您的邮箱已订阅 XyDesk 新闻。',
    'es': '¡Listo! Tu correo está suscrito a las noticias de XyDesk.',
    'pt': 'Pronto! Seu e-mail está inscrito nas notícias do XyDesk.',
    'ar': 'تم! تم تسجيل بريدك لأخبار XyDesk.',
  },
  'news_subscribe_dup': {
    ...
    'pt': 'Este e-mail já está inscrito.',
    'ar': 'هذا البريد مسجل بالفعل.',
  },
  'news_subscribe_err': {
    'id': 'Gagal mendaftar email. Coba lagi.',
    'en': 'Failed to subscribe. Try again.',
    'zh': '订阅失败，请重试。',
    'es': 'No se pudo suscribir. Inténtalo de nuevo.',
    'pt': 'Falha ao assinar. Tente novamente.',
    'ar': 'تعذر الاشتراك. حاول مرة أخرى.',
  },
  'exit_double_tap_hint': {
    'id': 'Tekan sekali lagi untuk keluar',
    'en': 'Press again to exit',
    'zh': '再按一次退出',
    'es': 'Pulsa de nuevo para salir',
  ...
  'auth_google': {
    'id': 'Daftar atau masuk dengan Google',
    'en': 'Sign up or sign in with Google',
    'zh': '使用 Google 注册或登录',
    'es': 'Regístrate o inicia sesión con Google',
    'pt': 'Cadastre-se ou entre com Google',
    'ar': 'التسجيل أو الدخول عبر Google',
  },
  'auth_email': {
    'id': 'Daftar atau masuk dengan Email',
    'en': 'Sign up or sign in with Email',
    'zh': '使用邮箱注册或登录',
    'es': 'Regístrate o inicia sesión con correo',
    'pt': 'Cadastre-se ou entre com e-mail',
    'ar': 'التسجيل أو الدخول بالبريد',
  },
  'auth_guest': {
    'id': 'Pakai tanpa akun',
  ...
  'auth_invalid_name': {
    'id': 'Nama harus terdiri dari 2 sampai 80 karakter',
    'en': 'Name must be between 2 and 80 characters',
    'zh': '姓名必须为 2 到 80 个字符',
    'es': 'El nombre debe tener entre 2 y 80 caracteres',
    'pt': 'O nome deve ter entre 2 e 80 caracteres',
    'ar': 'يجب أن يتراوح الاسم بين حرفين و80 حرفًا',
  },
  'auth_email_label': {
    'id': 'Alamat email',
    'en': 'Email address',
