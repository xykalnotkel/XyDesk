...
const _firstNames = [
  'Aditya', 'Budi', 'Citra', 'Dewi', 'Eko', 'Fajar', 'Gilang', 'Hana',
  'Indra', 'Joko', 'Kirana', 'Lukman', 'Maya', 'Nanda', 'Oki', 'Putri',
  'Raka', 'Sari', 'Taufik', 'Umar', 'Vina', 'Wawan', 'Yanti', 'Zaki',
  'Arif', 'Bella', 'Cahya', 'Dimas', 'Elsa', 'Farhan', 'Gita', 'Hendra',
  'Ika', 'Jihan', 'Kurnia', 'Lestari', 'Maulana', 'Nisa', 'Omar', 'Putra',
  'Rizky', 'Sinta', 'Teguh', 'Umi', 'Vero', 'Wulan', 'Yusuf', 'Zahra',
  'Bagas', 'Cindy', 'Dani', 'Eva', 'Faisal', 'Galih', 'Hesti', 'Irwan',
  'Julia', 'Kenji', 'Lia', 'Mirza', 'Novi', 'Okta', 'Prima', 'Rina',
];

/// Daftar nama belakang Indonesia yang umum.
const _lastNames = [
  'Pratama', 'Saputra', 'Wibowo', 'Hidayat', 'Nugroho', 'Setiawan',
  'Kurniawan', 'Santoso', 'Wijaya', 'Permadi', 'Utama', 'Surya',
  'Laksana', 'Pranata', 'Maulana', 'Hakim', 'Firmansyah', 'Ramadhan',
  'Putra', 'Dewanto', 'Kusuma', 'Ananda', 'Sari', 'Lestari',
  'Purnama', 'Handayani', 'Wulandari', 'Kartika', 'Anggraini',
  'Prasetyo', 'Susanto', 'Hartono', 'Sutanto', 'Tjandra', 'Gunawan',
];
