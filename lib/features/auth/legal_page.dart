...
class LegalPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        padding:
            const EdgeInsets.fromLTRB(Gap.screen, Gap.md, Gap.screen, Gap.h40),
        children: [
          Text('Berlaku sejak 7 Agustus 2026 · Versi 1.0',
  ...
  List<Widget> _licenses(BuildContext c) => [
        _para(c,
            'XyDesk dibangun di atas perangkat lunak sumber terbuka berikut.'),
...
Widget _sec(BuildContext c, String t) => Padding(
      ...
      child: Text(t,
          style: TextStyle(
              fontSize: 15, fontWeight: FontWeight.w600, color: c.c.textHi)),
    );
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color: c.c.textLow, shape: BoxShape.circle),
                    ),
                  ),
                  Expanded(
                    child: Text(i,
                        style: TextStyle(
                            fontSize: 13, height: 1.6, color: c.c.textMid)),
                  ),
                ],
              ),
            ),
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(t,
                style:
                    TextStyle(fontSize: 12.5, height: 1.6, color: c.c.textHi)),
          ),
        ],
      ),
    );
