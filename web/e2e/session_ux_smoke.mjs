...
try{
 ...
 await page.goto('http://127.0.0.1:4177/control-fixture');
  ...
  if(viewport.width===844)await page.screenshot({path:new URL('../../docs/qa/control-refine-keyboard-2026-09-18.png',import.meta.url).pathname});
...
assert.equal(await page.locator('.remote-control-cursor').isVisible(),false);
  ...
  if(viewport.width===844)await page.screenshot({path:new URL('../../docs/qa/control-refine-editor-2026-09-18.png',import.meta.url).pathname});
  await page.getByRole('button',{name:'Simpan layout',exact:true}).click();
  await page.evaluate(()=>window.__inputs=[]);
  ...
  if(viewport.width===844)await page.screenshot({path:new URL('../../docs/qa/control-refine-mapping-2026-09-18.png',import.meta.url).pathname});
  await page.getByRole('button',{name:'Panel gaming',exact:true}).click();
  ...
  if(viewport.width===844)await page.screenshot({path:new URL('../../docs/qa/control-refine-ui-2026-09-18.png',import.meta.url).pathname});
  ...
  if(viewport.width===844)await page.screenshot({fullPage:true,path:new URL('../../docs/qa/control-refine-history-2026-09-18.png',import.meta.url).pathname});
 ...
 writeFileSync(new URL('../../docs/qa/control-refine-ui-2026-09-18.json',import.meta.url),JSON.stringify({result:'PASS',boundary:'Real React handlers, Chromium CDP touch events, local canvas stream; stubbed RtcSession transport, not Windows/Android injection',checks},null,2)+'\n');
